...
import { CONFIG, GITHUB_REPO, UPDATE_CHECK_INTERVAL, CURRENT_VERSION } from './config.js';
import TagShield from './modules/TagShield.js';
import { checkForUpdates, isNewerVersion, showUpdateNotification } from './core/RuleEngine.js';
...
class ShieldSystem {
    ...
    bindGlobalEvents() {
        ...
        GM_registerMenuCommand('导出配置', this.exportConfig.bind(this));
